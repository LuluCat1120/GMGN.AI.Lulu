        ...
        Container(
          ...
          child: Row(
            children: [
              ...
              const Expanded(child: Text('Token', style: TextStyle(color: Colors.grey, fontSize: 14))),
              Row(
                mainAxisSize: MainAxisSize.min,
                children: [
              ...
              const SizedBox(width: 16),
              const Text('Profit', style: TextStyle(color: Colors.grey, fontSize: 14)),
              const SizedBox(width: 16),
